					...
					<div className='relative z-10'>
						<div className='flex flex-col sm:flex-row p-6 gap-4 sm:gap-6 pb-8 items-center sm:items-end text-center sm:text-left'>
							<img
								...
								className='w-32 h-32 sm:w-[240px] sm:h-[240px] shadow-xl rounded object-cover'
							/>
							<div className='flex flex-col justify-end'>
								<p className='text-sm font-medium'>Album</p>
								<h1 className='text-2xl sm:text-4xl md:text-5xl lg:text-7xl font-bold my-4 break-words'>
									{currentAlbum?.title}
								</h1>
								<div className='flex flex-wrap justify-center sm:justify-start items-center gap-2 text-sm text-zinc-100'>
